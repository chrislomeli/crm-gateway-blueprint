...
### FILE: intent-subscriber/Dockerfile
```
# Build stage
...
CMD ["node", "dist/webhook-subscriber.app.js"]
```

### FILE: intent-subscriber/package.json
```
{
  "name": "@service/intent-subscriber",
  "version": "1.0.0",
  "type": "module",
  "description": "Intent subscriber service for processing intent extraction from queue messages",
...
### FILE: intent-subscriber/tsconfig.json
```
{
  "compilerOptions": {
    "target": "ES2022",
...
### FILE: intent-subscriber/tsup.config.ts
```
import { defineConfig } from 'tsup';

export default defineConfig({
    entry: ['src/intent-handler.ts'],
    format: ['esm'],
    dts: true,
    sourcemap: true,
    clean: true,
...
### FILE: intent-subscriber/vitest.config.js
```
...
### FILE: intent-subscriber/vitest.config.ts
```
import { defineConfig } from 'vitest/config';
...
### FILE: intent-subscriber/src/context-provider.ts
```
/**
...
### FILE: intent-subscriber/src/intent-handler.ts
```
/**
...
import {HealthChecker, DatabaseHealthChecks, SQSHealthChecks, ElasticsearchHealthChecks} from '@platform/infrastructure';
...
### FILE: intent-subscriber/src/sqs-message-consumer.ts
```
/**
 * intent.consumer.ts
 *
...
export async function processWebhookMessages(messageProcessor: MessageProcessor, context: ApplicationContext) {
    try {
        ...
        // Generate worker ID
        const workerId = `${os.hostname()}-${process.pid}-${uuid4().substring(0, 8)}`;
...
### FILE: webhook-subscriber/Dockerfile
```
# Build stage
FROM node:18-alpine AS builder
...
### FILE: webhook-subscriber/package.json
```
{
...
### FILE: webhook-subscriber/tsconfig.json
```
{
  "compilerOptions": {
    "target": "ES2022",
...
### FILE: webhook-subscriber/tsup.config.ts
```
import { defineConfig } from 'tsup';
...
### FILE: webhook-subscriber/vitest.config.js
```
import { defineConfig } from 'vitest/config'
...
### FILE: webhook-subscriber/vitest.config.ts
```
import { defineConfig } from 'vitest/config';
import { resolve } from 'path';
...
### FILE: webhook-subscriber/src/context-provider.ts
```
/**
 * context-provider.ts - Context Utilities for File Processors
 *
...
### FILE: webhook-subscriber/src/sqs-message.consumer.ts
```
/**
 * intent.consumer.ts
 *
...
### FILE: webhook-subscriber/src/webhook-handler.ts
```
/**
 * Webhook Processing Service
 *
