create
    definer = qa_calls_10_24_2024@`%` procedure updatePowerlistContactOwnerByBusinessIdPhone(IN varBusinessId bigint(19),
                                                                                             IN var164PhoneNumber varchar(25),
                                                                                             IN varOwnerUserId varchar(25))
BEGIN
